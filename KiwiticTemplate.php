            ...
            <div class="liberty-sidebar">
                ...
                <div class="right-ads">
                    <ins class="adsbygoogle"
						...
						data-ad-client="ca-pub-6081569795236180"
						data-ad-slot="4545283356"
                        data-ad-format="auto">
                    </ins>
                </div>
            </div>
                ...
                <div class="liberty-content-main">
                    <?php if ( $title->getNamespace() != NS_SPECIAL && $action != "edit" && $action != "history") { ?>
                        <div class="social-buttons">
                            <div class="google" data-url="https://kiwki.us/wiki/<?php $this->html( 'title' ) ?>" data-text="<?php $this->html( 'title' ) ?>" title="구글플러스"><div><i class="fa fa-google-plus"></i></div></div>
                            <div class="twitter" data-url="https://kiwki.us/?curid=<?=$curid;?>" data-text="[<?php $this->html( 'title' ) ?>]%0A" title="트위터"><div><i class="fa fa-twitter"></i></div></div>
                            <div class="facebook" data-url="https://kiwki.us/wiki/<?php $this->html( 'title' ) ?>" data-text="<?php $this->html( 'title' ) ?>" title="페이스북"><div><i class="fa fa-facebook"></i></div></div>
                        </div>
                    <?php } ?>
